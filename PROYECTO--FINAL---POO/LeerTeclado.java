...
public class LeerTeclado
{
  ...
  public static double LeerDoble(String Cad){
    double doble=0;
    boolean leidobien=false;
    while(!leidobien){
    try{
  ...
  public static boolean LeerBooleano(String Cad){
  ...
  public static String LeerCadenaLetrasYnumeros(String Cad2){    
    String cad="";  
    boolean leidobien=false;
  ...
  public static String LeerCadenaLetrasYSimbolos(){    
    ...
    while(!leidobien){
      try{
       String p=LeerString(Cad2);
       if(p.matches(".*[a-zA-Z]+[^ 0-9]+[\\x00-\\x7F]")){
          cad=p;
          leidobien=true;
          }else{
            throw new Exception(); }
